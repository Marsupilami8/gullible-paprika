...
.DESCRIPTION
    ...
    notes from each of forensic image acquisition and the results of the computed MD5 and SHA1 hash verifications.
...
.NOTES
    ...
    The script outputs som stderr messages that can be piped to 2>1 | $null for cleaner output when the Powershell is run in an IDE.
